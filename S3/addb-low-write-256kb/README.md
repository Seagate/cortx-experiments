...
[Histogramm](./hist-256kb-nw-detailed.png)
...
Resulting ".dat" files are stored in [**raw-data**](./raw-data/) directory together with corresonding
...
For more details check [Histogramm](./hist-256kb-nw-detailed.png).

For timeline processing for each state two requests were choosen - 1st corresponding to phase's max duration
...
|                                            | S3Action::set_authorization_meta to S3Action::check_authorization                                  | loads data from kvs responcies to internal structs                                                  |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
| send_response_to_s3_client_max.dat.png     |                                                                                                    | Max 657.65 PID 296826 ID 6390                                                                       | there are no any external ops - such a long time should be checked; send_response is complex operation, includes mutex and chanked event buffer modifications;                                                                                                                                                                                                                                                                                                                                                                                                                  |
