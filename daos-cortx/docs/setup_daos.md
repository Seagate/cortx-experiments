...
* Use this [server config file](https://github.com/Seagate/cortx-experiments/blob/main/daos-cortx/src/samples/daos_server.yml) which is having minimum settings to up and running a single node server. Copy this example file's configurations to /etc/daos/daos_server.yml
